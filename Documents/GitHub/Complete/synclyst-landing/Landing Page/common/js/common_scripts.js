...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 300) {
            ...
            navbar.css({ 'background': '#ffffff', 'box-shadow': '0 2px 20px rgba(0,0,0,0.08)', 'backdrop-filter': 'none' });
            navbar.find('.nav-link').css('color', '#111111');
            navbar.find('.navbar-nav').css('border-color', 'rgba(0,0,0,0.14)');
            navbar.find('.synclyst-logo').css('color', '#111111');
            navbar.find('.topnav .butn').css({ 'background': '#111111', 'color': '#ffffff' });
            logo.attr('src', 'assets/imgs/logo-dark.png');

        } else {

            navbar.removeClass("nav-scroll");
            navbar.css({ 'background': '', 'box-shadow': '', 'backdrop-filter': '' });
            navbar.find('.nav-link').css('color', '');
            navbar.find('.navbar-nav').css('border-color', '');
            navbar.find('.synclyst-logo').css('color', '');
            navbar.find('.topnav .butn').css({ 'background': '', 'color': '' });
